...
TODO:
1. Вычислить максимально возможный объем памяти для архитектуры x86-64 (разрядность адреса = 8 Байт);
2. Есть массив из десяти элементов, завполненный слкчайными числами.
   Необходимо создать еще два амассива минимально возможного размера, even[] и odd[],
   в массив even[] нужно скопировать все четные значения из исходного массива, а в массив odd[] - нечетные.
...
DONE:
Есть массив из десяти элементов, заполненный заведомо повторяющимися значениями.
Необходимо найти повторяющиеся значения, вывести их на экран, а так же вывести на экран
количество повторений каждого такого значения.

DONE:
1. Сдвинуть массив на заданное число элементов вправо;
2. В проекте Rand отсортировать массив, заполненный случайными числами;
